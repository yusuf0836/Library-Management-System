...
<head>
    ...
    <title>Circulation Report | Library Management System</title>
...
<body class="bg-light">
    ...
    <main class="container py-4">
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
            <div>
                <h2 class="mb-1">Circulation Report</h2>
                <p class="text-muted mb-0">
                    View and export book issue and return records.
                </p>
            </div>
        ...
        @if ($issues->hasPages())
            <div class="d-flex justify-content-between align-items-center mt-3">
                ...
                @else
                    <a class="btn btn-outline-secondary" href="{{ $issues->previousPageUrl() }}">
                        Previous
                    </a>
                @endif
                ...
                @if ($issues->hasMorePages())
                    <a class="btn btn-outline-secondary" href="{{ $issues->nextPageUrl() }}">
                        Next
                    </a>
                @else
