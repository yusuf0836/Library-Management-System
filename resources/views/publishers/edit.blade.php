    ...
    <main class="container">
        <section class="card">
            ...
            <form action="{{ route('publishers.update', $publisher) }}" method="POST">
                ...
                <input id="email" type="email" name="email" value="{{ old('email', $publisher->email) }}">
                ...
                <input id="phone" type="text" name="phone" value="{{ old('phone', $publisher->phone) }}">
                ...
                <textarea id="address" name="address">{{ old('address', $publisher->address) }}</textarea>
                ...
                <div class="buttons">
                    <button class="button" type="submit">Update Publisher</button>
